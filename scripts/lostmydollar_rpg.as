package
{
   ...
   [Embed(source="/_assets/assets.swf", symbol="symbol2711")]
   public dynamic class lostmydollar_rpg extends MovieClip
   {
      ...
      {
         super();
         addFrameScript(0,this.frame1,9,this.frame10,14,this.frame15,29,this.frame30,39,this.frame40,49,this.frame50);
      }
